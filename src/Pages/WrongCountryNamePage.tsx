...
// IF THE USER TYPE IN THE URL A COUNTRY THAT DOES NOT EXIST 
export function WrongCountryNamePage(): JSX.Element {
  ...
  return (
    <main className={` flex items-center h-screen flex-col mt-20 gap-3 
      ...
      <h1 className="text-3xl font-bold">No country with this name</h1>
